...
namespace ThisIsWin11
{
    public partial class MainWindow : Form
    {
        ...
        /// </summary>
        private void menuTweaker_Click(object sender, EventArgs e) { TweakerWindow tw = new TweakerWindow(this); tw.Show(this); textPS.Visible = true; }
